...
def save_model(session, input_tensor, output_tensor):
    ...
    b = saved_model_builder.SavedModelBuilder('./saved_model')
...
#
  for epoch in range(10):  # Try increasing the number of epochs
    for i in range(55000 // 50):  # 55000 is the size of the MNIST training set
        batch = mnist.train.next_batch(50)
        if i % 100 == 0:
